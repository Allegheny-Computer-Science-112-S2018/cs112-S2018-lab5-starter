...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfive/experiment \
                                     --checkfiles Experiment.java --fragments "println(" --fragmentcounts 7
  determine_exit_code $?
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --commits 19
  determine_exit_code $?
 echo ""
